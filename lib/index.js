...
//
// ** PUT has a new caveat added with the new bindable currying code.
// The last value of arguments is always considered the value.
// In other functions if this value is an array it is merged with the current 
// path, however here we cannot make that assumption
//
...
var put = module.exports.put = function put(object, path, value) {
  if (arguments.length === 2) {
    ...
    var acc = [];
    // Requires a slightly more complex version because of the value arg
...
var remove = module.exports.remove = function remove(object, path) {
  if (arguments.length === 2) {
    if (typeof path === "string") {
      path = path.split(".");
    }
